...
const teamPhoto = "/assets/team_photo.jpg";
const philosophyIcon1 = "/assets/icon_creativity.png";
const philosophyIcon2 = "/assets/icon_functionality.png";
const philosophyIcon3 = "/assets/icon_client_centric.png";

const jalandharRaurPhoto = "/assets/jalandhar_raur.jpg";
const gyandharSahniPhoto = "/assets/gyandhar_photo.jpg";
const gulabChandraPhoto = "/assets/gulab_chandra.jpeg";
  ...
  return (
    <div className="pt-24 pb-12 bg-gray-50">
      <div className="container mx-auto px-6">
        <motion.h1
          className="text-4xl md:text-5xl font-bold text-gray-800 text-center mb-6 pt-12"
